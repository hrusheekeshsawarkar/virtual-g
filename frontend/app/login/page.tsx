  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-3 sm:p-4 safe-area-inset">
      <form onSubmit={onSubmit} className="glass w-full max-w-sm space-y-4 rounded-xl p-4 sm:p-6">
        ...
        <Button className="w-full touch-manipulation" type="submit">Login</Button>
        <p className="text-center text-sm text-white/60">
          Don&apos;t have an account? <a className="text-primary hover:text-primary/80 transition-colors touch-manipulation" href="/register">Register</a>
        </p>
      </form>
    </main>
  )
